...
class Systems extends Model
{
    ...
    {
        Yii::$app->cacheHelper->delete(self::cacheKeyForOptions());
     ...
     * @return string
     */
    public static function cacheKeyForOptions()
    {
        return Yii::$app->id . ":system:options:all";
    }
    ...
    {
        // 调用频率太高，这里使用缓存获取，减少db的查询，无逻辑，这里不设置db依赖
        return Yii::$app->cacheHelper->get(self::cacheKeyForOptions(), function () {
            $systems = Systems::find()
                ...
                ->asArray()
                ->all();
            return array_combine(array_column($systems, 'code'), array_column($systems, 'name'));
        }, 300);
    }
}
